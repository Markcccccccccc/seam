...
int main(int argc, char * argv[])
{
    ...
    int C_BOUND = atoi(argv[2]);
    int real_period1 = atoi(argv[3]);
    int real_period2 = atoi(argv[4]);
    int real_period3 = atoi(argv[5]);
    int real_period4 = atoi(argv[6]);
    int real_period5 = atoi(argv[7]);
    int real_period6 = atoi(argv[8]);
    string result_path = argv[9];
    printf("======================================================");
    // printf(channel_num, C_BOUND, real_period1, real_period2, real_period3, real_period4);
    ...
    case 2:
    {
        cout << " We have started test 2" << endl;
        ...
        rclcpp::shutdown();
        cout << " We have finished test " << endl;
        break;
    }
    case 3:
    {   
        ...
        // {
            cout << " We have started test 3" << endl;
            rclcpp::init(argc, argv);
            // rclcpp::executors::SingleThreadedExecutor executor;
            // rclcpp::executors::MultiThreadedExecutor executor(rclcpp::executor::ExecutorArgs(),50);
            rclcpp::executors::MultiThreadedExecutor executor(rclcpp::ExecutorOptions(),50);
    ...
    case 4:
    {
        ...
        // while(count < test_num)
        // {
            cout << " We have started test 4" << endl;
            rclcpp::init(argc, argv);
            // rclcpp::executors::SingleThreadedExecutor executor;
            // rclcpp::executors::MultiThreadedExecutor executor(rclcpp::executor::ExecutorArgs(),50);
            rclcpp::executors::MultiThreadedExecutor executor(rclcpp::ExecutorOptions(),50);
    ...
    case 5:
    {
        cout << " We have started test 5" << endl;
        rclcpp::init(argc, argv);
        // rclcpp::executors::SingleThreadedExecutor executor;
        // rclcpp::executors::MultiThreadedExecutor executor(rclcpp::executor::ExecutorArgs(),50);
        rclcpp::executors::MultiThreadedExecutor executor(rclcpp::ExecutorOptions(),50);
