    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic2(int period1, int period2, int C_BOUND, std::ofstream& file_mdl) :
        Node("subscriber_topic2"), file_mdl_(file_mdl),
        mdl_sync_(), period1_(period1), period2_(period2),
        count_mdl_(0), delay_previous1_(0), delay_previous2_(0),
        mdl_observed_wctd_(0), previous_timestamp1_(0), previous_timestamp2_(0), observed_wcp1_(0), observed_wcp2_(0), observed_wcp1_temp_(0), observed_wcp2_temp_(0)
    {
        ...
        this->declare_parameter("num_published_set", 100);
        this->get_parameter("num_published_set", num_published_set_);
        
        this->declare_parameter("period_factor", 1.2);
        this->declare_parameter("msg_period_bias_flag", true);
        
        this->get_parameter("period_factor", period_factor_);
        this->get_parameter("msg_period_bias_flag", msg_period_bias_flag_);

        max_period_ = 1e-3 * std::max({period1_, period2_})*period_factor_;
        // printf("max_period_: %f\n", max_period_);
        RCLCPP_INFO(this->get_logger(), "required number of published sets: %d.T", num_published_set_);
    ...
    void mdl_callback(const sensor_msgs::msg::JointState::ConstSharedPtr& msg1, const sensor_msgs::msg::JointState::ConstSharedPtr& msg2)
    {
        ...
        if(count_mdl_ >= num_published_set_||should_terminate_)
        {
            cout << "SEAM has got enough published sets !" << endl;

            file_mdl_ << observed_bcp1_ << " " << observed_bcp2_ << " ";
            file_mdl_ << observed_wcp1_ << " " << observed_wcp2_ << " ";
            file_mdl_ << min_trans_delay1_ /  Mstos << " " << min_trans_delay2_ /  Mstos << " ";
            file_mdl_ << max_trans_delay1_ /  Mstos << " " << max_trans_delay2_ /  Mstos << " ";
            file_mdl_ << max_passing_latency1_ << " " << max_passing_latency2_ << " ";
            file_mdl_ << max_reaction_latency1_ << " " << max_reaction_latency2_ << endl;

            kill(getpid(),SIGINT);
            return;
        }
        RCLCPP_INFO(this->get_logger(), "count_mdl_: %d <= %d", count_mdl_, num_published_set_);
        count_mdl_++;
    ...
    void callback1(sensor_msgs::msg::JointState::SharedPtr msg)
    {
        ...
        if(count_mdl_ < num_published_set_)
        {
            if(previous_timestamp1_ > 0)
            {
                ...
                if(observed_now > observed_wcp1_temp_)
                {
                    observed_wcp1_temp_ = observed_now;
                    if (observed_wcp1_temp_ <= max_period_&&!should_terminate_)
                    {
                        observed_wcp1_ = observed_wcp1_temp_;
                    }
                    else
                    {
                        cout << "Observed period is too large: " << observed_now << endl;
                        cout<< "Observed period is larger than max_period_: " << observed_wcp1_ << endl;
                        if (!should_terminate_) {
                            should_terminate_ = true;
                            RCLCPP_INFO(this->get_logger(), "Set should_terminate_ to true. Triggering shutdown soon.");
                        }
                    }
    ...
    void callback2(sensor_msgs::msg::JointState::SharedPtr msg)
    {
        ...
        if(count_mdl_ < num_published_set_)
        {
            if(previous_timestamp2_ > 0)
            {
                ...
                if(observed_now > observed_wcp2_temp_)
                {
                    observed_wcp2_temp_ = observed_now;
                    if (observed_wcp2_temp_ <= max_period_&&!should_terminate_)
                    {
                        observed_wcp2_ = observed_wcp2_temp_;
                    }
                    else
                    {
                        cout << "Observed period is too large: " << observed_now << endl;
    ...
    typedef Synchronizer<sync_policies::SEAM<sensor_msgs::msg::JointState, sensor_msgs::msg::JointState> > MdlSync;
    ...
    double observed_wcp1_, observed_wcp2_, observed_wcp1_temp_, observed_wcp2_temp_;
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic3(int period1, int period2, int period3, int C_BOUND, std::ofstream& file_mdl) :
        Node("subscriber_topic3"), file_mdl_(file_mdl),
        mdl_sync_(), period1_(period1), period2_(period2), period3_(period3),
        count_mdl_(0), delay_previous1_(0.), delay_previous2_(0), delay_previous3_(0),
        mdl_observed_wctd_(0), previous_timestamp1_(0), previous_timestamp2_(0), previous_timestamp3_(0), observed_wcp1_(0), observed_wcp2_(0), observed_wcp3_(0)
    {
        ...
        max_period_ = 1e-3 * std::max({period1_, period2_, period3_})*period_factor_;
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg3)
    {
        ...
        if(count_mdl_ >= num_published_set_||should_terminate_)
        {
            ...
            file_mdl_ << observed_bcp1_ << " " << observed_bcp2_ << " " << observed_bcp3_ << " ";
            file_mdl_ << observed_wcp1_ << " " << observed_wcp2_ << " " << observed_wcp3_ << " ";
            file_mdl_ << min_trans_delay1_ /  Mstos << " " << min_trans_delay2_ /  Mstos << " " << min_trans_delay3_ /  Mstos << " ";
            file_mdl_ << max_trans_delay1_ /  Mstos << " " << max_trans_delay2_ /  Mstos << " " << max_trans_delay3_ /  Mstos << " ";
            file_mdl_ << max_passing_latency1_ << " " << max_passing_latency2_ << " " << max_passing_latency3_ << " ";
            file_mdl_ << max_reaction_latency1_ << " " << max_reaction_latency2_ << " " << max_reaction_latency3_ << endl;
    ...
    typedef Synchronizer<sync_policies::SEAM<sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState> > MdlSync;
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic4(int period1, int period2, int period3, int period4, int C_BOUND, std::ofstream& file_mdl) :
        Node("subscriber_topic4"), file_mdl_(file_mdl), 
        mdl_sync_(), 
        ...
        observed_wcp1_(0), observed_wcp2_(0), observed_wcp3_(0), observed_wcp4_(0)
    {
        ...
        max_period_ = 1e-3 * std::max({period1_, period2_, period3_, period4_})*period_factor_;
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg3, const sensor_msgs::msg::JointState::ConstSharedPtr& msg4)
    {
        ...
        if(count_mdl_ >= num_published_set_||should_terminate_)
        {
            ...
            file_mdl_ << observed_bcp1_ << " " << observed_bcp2_ << " " << observed_bcp3_ << " " << observed_bcp4_ << " ";
            file_mdl_ << observed_wcp1_ << " " << observed_wcp2_ << " " << observed_wcp3_ << " " << observed_wcp4_ << " ";
            file_mdl_ << min_trans_delay1_ /  Mstos << " " << min_trans_delay2_ /  Mstos << " " << min_trans_delay3_ /  Mstos << " " << min_trans_delay4_ /  Mstos << " ";
            file_mdl_ << max_trans_delay1_ /  Mstos << " " << max_trans_delay2_ /  Mstos << " " << max_trans_delay3_ /  Mstos << " " << max_trans_delay4_ /  Mstos << " ";
            file_mdl_ << max_passing_latency1_ << " " << max_passing_latency2_ << " " << max_passing_latency3_ << " " << max_passing_latency4_ << " ";
            file_mdl_ << max_reaction_latency1_ << " " << max_reaction_latency2_ << " " << max_reaction_latency3_ << " " << max_reaction_latency4_ << endl;
    ...
    typedef Synchronizer<sync_policies::SEAM<sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState> > MdlSync;
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic5(int period1, int period2, int period3, int period4, int period5, int C_BOUND, std::ofstream& file_mdl) :
        Node("subscriber_topic5"), file_mdl_(file_mdl),
        mdl_sync_(), 
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg5)
    {
        ...
        if(count_mdl_ >= num_published_set_)
        {
            ...
            file_mdl_ << observed_bcp1_ << " " << observed_bcp2_ << " " << observed_bcp3_ << " " << observed_bcp4_ << " " << observed_bcp5_ << " ";
            file_mdl_ << observed_wcp1_ << " " << observed_wcp2_ << " " << observed_wcp3_ << " " << observed_wcp4_ << " " << observed_wcp5_ << " ";
            file_mdl_ << min_trans_delay1_ /  Mstos << " " << min_trans_delay2_ /  Mstos << " " << min_trans_delay3_ /  Mstos << " " << min_trans_delay4_ /  Mstos << " " << min_trans_delay5_ /  Mstos << " ";
            file_mdl_ << max_trans_delay1_ /  Mstos << " " << max_trans_delay2_ /  Mstos << " " << max_trans_delay3_ /  Mstos << " " << max_trans_delay4_ /  Mstos << " " << max_trans_delay5_ /  Mstos << " ";
            file_mdl_ << max_passing_latency1_ << " " << max_passing_latency2_ << " " << max_passing_latency3_ << " " << max_passing_latency4_ << " " << max_passing_latency5_ << " ";
            file_mdl_ << max_reaction_latency1_ << " " << max_reaction_latency2_ << " " << max_reaction_latency3_ << " " << max_reaction_latency4_ << " " << max_reaction_latency5_ << endl;
    ...
    typedef Synchronizer<sync_policies::SEAM<sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState> > MdlSync;
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic6(int period1, int period2, int period3, int period4, int period5, int period6, int C_BOUND, std::ofstream& file_mdl) :
        Node("subscriber_topic6"), file_mdl_(file_mdl),
        mdl_sync_(), 
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg5, const sensor_msgs::msg::JointState::ConstSharedPtr& msg6)
    {
        ...
        if(count_mdl_ >= num_published_set_)
        {
            ...
            file_mdl_ << observed_bcp1_ << " " << observed_bcp2_ << " " << observed_bcp3_ << " " << observed_bcp4_ << " " << observed_bcp5_ << " " << observed_bcp6_ << " ";
            file_mdl_ << observed_wcp1_ << " " << observed_wcp2_ << " " << observed_wcp3_ << " " << observed_wcp4_ << " " << observed_wcp5_ << " " << observed_wcp6_ << " ";
            file_mdl_ << min_trans_delay1_ /  Mstos << " " << min_trans_delay2_ /  Mstos << " " << min_trans_delay3_ /  Mstos << " " << min_trans_delay4_ /  Mstos << " " << min_trans_delay5_ /  Mstos << " " << min_trans_delay6_ /  Mstos << " ";
            file_mdl_ << max_trans_delay1_ /  Mstos << " " << max_trans_delay2_ /  Mstos << " " << max_trans_delay3_ /  Mstos << " " << max_trans_delay4_ /  Mstos << " " << max_trans_delay5_ /  Mstos << " " << max_trans_delay6_ /  Mstos << " ";
            file_mdl_ << max_passing_latency1_ << " " << max_passing_latency2_ << " " << max_passing_latency3_ << " " << max_passing_latency4_ << " " << max_passing_latency5_ << " " << max_passing_latency6_ << " ";
            file_mdl_ << max_reaction_latency1_ << " " << max_reaction_latency2_ << " " << max_reaction_latency3_ << " " << max_reaction_latency4_ << " " << max_reaction_latency5_ << " " << max_reaction_latency6_ << endl;
    ...
    typedef Synchronizer<sync_policies::SEAM<sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState> > MdlSync;
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic7(int period1, int period2, int period3, int period4, int period5, int period6, int period7, int C_BOUND, std::ofstream& file_mdl) :
        Node("subscriber_topic7"), file_mdl_(file_mdl),
        mdl_sync_(), 
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg7)
    {
        ...
        if(count_mdl_ >= num_published_set_)
        {
            ...
            file_mdl_ << observed_bcp1_ << " " << observed_bcp2_ << " " << observed_bcp3_ << " " << observed_bcp4_ << " " << observed_bcp5_ << " " << observed_bcp6_ << " " << observed_bcp7_ << " ";
            file_mdl_ << observed_wcp1_ << " " << observed_wcp2_ << " " << observed_wcp3_ << " " << observed_wcp4_ << " " << observed_wcp5_ << " " << observed_wcp6_ << " " << observed_wcp7_ << " ";
            file_mdl_ << min_trans_delay1_ /  Mstos << " " << min_trans_delay2_ /  Mstos << " " << min_trans_delay3_ /  Mstos << " " << min_trans_delay4_ /  Mstos << " " << min_trans_delay5_ /  Mstos << " " << min_trans_delay6_ /  Mstos << " " << min_trans_delay7_ /  Mstos << " ";
            file_mdl_ << max_trans_delay1_ /  Mstos << " " << max_trans_delay2_ /  Mstos << " " << max_trans_delay3_ /  Mstos << " " << max_trans_delay4_ /  Mstos << " " << max_trans_delay5_ /  Mstos << " " << max_trans_delay6_ /  Mstos << " " << max_trans_delay7_ /  Mstos << " ";
            file_mdl_ << max_passing_latency1_ << " " << max_passing_latency2_ << " " << max_passing_latency3_ << " " << max_passing_latency4_ << " " << max_passing_latency5_ << " " << max_passing_latency6_ << " " << max_passing_latency7_ << " ";
            file_mdl_ << max_reaction_latency1_ << " " << max_reaction_latency2_ << " " << max_reaction_latency3_ << " " << max_reaction_latency4_ << " " << max_reaction_latency5_ << " " << max_reaction_latency6_ << " " << max_reaction_latency7_ << endl;
    ...
    typedef Synchronizer<sync_policies::SEAM<sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState> > MdlSync;
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic8(int period1, int period2, int period3, int period4, int period5, int period6, int period7, int period8, int C_BOUND, std::ofstream& file_mdl) :
        Node("subscriber_topic8"), file_mdl_(file_mdl),
        mdl_sync_(), 
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg7, const sensor_msgs::msg::JointState::ConstSharedPtr& msg8)
    {
        ...
        if(count_mdl_ >= num_published_set_)
        {
            ...
            file_mdl_ << observed_bcp1_ << " " << observed_bcp2_ << " " << observed_bcp3_ << " " << observed_bcp4_ << " " << observed_bcp5_ << " " << observed_bcp6_ << " " << observed_bcp7_ << " " << observed_bcp8_ << " ";
            file_mdl_ << observed_wcp1_ << " " << observed_wcp2_ << " " << observed_wcp3_ << " " << observed_wcp4_ << " " << observed_wcp5_ << " " << observed_wcp6_ << " " << observed_wcp7_ << " " << observed_wcp8_ << " ";
            file_mdl_ << min_trans_delay1_ /  Mstos << " " << min_trans_delay2_ /  Mstos << " " << min_trans_delay3_ /  Mstos << " " << min_trans_delay4_ /  Mstos << " " << min_trans_delay5_ /  Mstos << " " << min_trans_delay6_ /  Mstos << " " << min_trans_delay7_ /  Mstos << " " << min_trans_delay8_ /  Mstos << " ";
            file_mdl_ << max_trans_delay1_ /  Mstos << " " << max_trans_delay2_ /  Mstos << " " << max_trans_delay3_ /  Mstos << " " << max_trans_delay4_ /  Mstos << " " << max_trans_delay5_ /  Mstos << " " << max_trans_delay6_ /  Mstos << " " << max_trans_delay7_ /  Mstos << " " << max_trans_delay8_ /  Mstos << " ";
            file_mdl_ << max_passing_latency1_ << " " << max_passing_latency2_ << " " << max_passing_latency3_ << " " << max_passing_latency4_ << " " << max_passing_latency5_ << " " << max_passing_latency6_ << " " << max_passing_latency7_ << " " << max_passing_latency8_ << " ";
            file_mdl_ << max_reaction_latency1_ << " " << max_reaction_latency2_ << " " << max_reaction_latency3_ << " " << max_reaction_latency4_ << " " << max_reaction_latency5_ << " " << max_reaction_latency6_ << " " << max_reaction_latency7_ << " " << max_reaction_latency8_ << endl;
    ...
    typedef Synchronizer<sync_policies::SEAM<sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState> > MdlSync;
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic9(int period1, int period2, int period3, int period4, int period5, int period6, int period7, int period8, int period9, int C_BOUND, std::ofstream& file_mdl) :
        Node("subscriber_topic9"), file_mdl_(file_mdl), 
        mdl_sync_(), 
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg9)
    {
        ...
        if(count_mdl_ >= num_published_set_)
        {
            ...
            file_mdl_ << observed_bcp1_ << " " << observed_bcp2_ << " " << observed_bcp3_ << " " << observed_bcp4_ << " " << observed_bcp5_ << " " << observed_bcp6_ << " " << observed_bcp7_ << " " << observed_bcp8_ << " " << observed_bcp9_ << " ";
            file_mdl_ << observed_wcp1_ << " " << observed_wcp2_ << " " << observed_wcp3_ << " " << observed_wcp4_ << " " << observed_wcp5_ << " " << observed_wcp6_ << " " << observed_wcp7_ << " " << observed_wcp8_ << " " << observed_wcp9_ << " ";
            file_mdl_ << min_trans_delay1_ /  Mstos << " " << min_trans_delay2_ /  Mstos << " " << min_trans_delay3_ /  Mstos << " " << min_trans_delay4_ /  Mstos << " " << min_trans_delay5_ /  Mstos << " " << min_trans_delay6_ /  Mstos << " " << min_trans_delay7_ /  Mstos << " " << min_trans_delay8_ /  Mstos << " " << min_trans_delay9_ /  Mstos << " ";
            file_mdl_ << max_trans_delay1_ /  Mstos << " " << max_trans_delay2_ /  Mstos << " " << max_trans_delay3_ /  Mstos << " " << max_trans_delay4_ /  Mstos << " " << max_trans_delay5_ /  Mstos << " " << max_trans_delay6_ /  Mstos << " " << max_trans_delay7_ /  Mstos << " " << max_trans_delay8_ /  Mstos << " " << max_trans_delay9_ /  Mstos << " ";
            file_mdl_ << max_passing_latency1_ << " " << max_passing_latency2_ << " " << max_passing_latency3_ << " " << max_passing_latency4_ << " " << max_passing_latency5_ << " " << max_passing_latency6_ << " " << max_passing_latency7_ << " " << max_passing_latency8_ << " " << max_passing_latency9_ << " ";
            file_mdl_ << max_reaction_latency1_ << " " << max_reaction_latency2_ << " " << max_reaction_latency3_ << " " << max_reaction_latency4_ << " " << max_reaction_latency5_ << " " << max_reaction_latency6_ << " " << max_reaction_latency7_ << " " << max_reaction_latency8_ << " " << max_reaction_latency9_ << endl;
    ...
    typedef Synchronizer<sync_policies::SEAM<sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState, sensor_msgs::msg::JointState> > MdlSync;
