    ...
    : public rclcpp::Node
{
    ...
    SubscriberTopic2(int period1, int period2, int C_BOUND, std::ofstream& file_mdl) :
        ...
        mdl_observed_wctd_(0), previous_timestamp1_(0), previous_timestamp2_(0), observed_wcp1_(0), observed_wcp2_(0)
    {
        ...
        RCLCPP_INFO(this->get_logger(), "required number of published sets: %d.NT", num_published_set_);
    ...
    void mdl_callback(const sensor_msgs::msg::JointState::ConstSharedPtr& msg1, const sensor_msgs::msg::JointState::ConstSharedPtr& msg2)
    {
        ...
        previous_arrival_time1_ = msg1->header.stamp;
        previous_arrival_time2_ = msg2->header.stamp;
    ...
    : public rclcpp::Node
{
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg3)
    {
        ...
        previous_arrival_time1_ = msg1->header.stamp;
        previous_arrival_time2_ = msg2->header.stamp;
        previous_arrival_time3_ = msg3->header.stamp;
    ...
    : public rclcpp::Node
{
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg3, const sensor_msgs::msg::JointState::ConstSharedPtr& msg4)
    {
        ...
        previous_arrival_time2_ = msg2->header.stamp;
        previous_arrival_time3_ = msg3->header.stamp;
        previous_arrival_time4_ = msg4->header.stamp;

        // Passing latency logging
        rclcpp::Time start_time1 = msg1->header.stamp;
        rclcpp::Time start_time2 = msg2->header.stamp;
        rclcpp::Time start_time3 = msg3->header.stamp;
        rclcpp::Time start_time4 = msg4->header.stamp;
    ...
    : public rclcpp::Node
{
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg5)
    {
        ...
        previous_arrival_time3_ = msg3->header.stamp;
        previous_arrival_time4_ = msg4->header.stamp;
        previous_arrival_time5_ = msg5->header.stamp;
        ...
        rclcpp::Time start_time3 = msg3->header.stamp;
        rclcpp::Time start_time4 = msg4->header.stamp;
        rclcpp::Time start_time5 = msg5->header.stamp;
    ...
    : public rclcpp::Node
{
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg5, const sensor_msgs::msg::JointState::ConstSharedPtr& msg6)
    {
        ...
        previous_arrival_time4_ = msg4->header.stamp;
        previous_arrival_time5_ = msg5->header.stamp;
        previous_arrival_time6_ = msg6->header.stamp;
        ...
        rclcpp::Time start_time4 = msg4->header.stamp;
        rclcpp::Time start_time5 = msg5->header.stamp;
        rclcpp::Time start_time6 = msg6->header.stamp;
    ...
    : public rclcpp::Node
{
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg7)
    {
        ...
        previous_arrival_time5_ = msg5->header.stamp;
        previous_arrival_time6_ = msg6->header.stamp;
        previous_arrival_time7_ = msg7->header.stamp;
        ...
        rclcpp::Time start_time5 = msg5->header.stamp;
        rclcpp::Time start_time6 = msg6->header.stamp;
        rclcpp::Time start_time7 = msg7->header.stamp;
    ...
    : public rclcpp::Node
{
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg7, const sensor_msgs::msg::JointState::ConstSharedPtr& msg8)
    {
        ...
        previous_arrival_time6_ = msg6->header.stamp;
        previous_arrival_time7_ = msg7->header.stamp;
        previous_arrival_time8_ = msg8->header.stamp;
        ...
        rclcpp::Time start_time6 = msg6->header.stamp;
        rclcpp::Time start_time7 = msg7->header.stamp;
        rclcpp::Time start_time8 = msg8->header.stamp;
    ...
    : public rclcpp::Node
{
                            ...
                            const sensor_msgs::msg::JointState::ConstSharedPtr& msg9)
    {
        ...
        previous_arrival_time7_ = msg7->header.stamp;
        previous_arrival_time8_ = msg8->header.stamp;
        previous_arrival_time9_ = msg9->header.stamp;
        ...
        rclcpp::Time start_time7 = msg7->header.stamp;
        rclcpp::Time start_time8 = msg8->header.stamp;
        rclcpp::Time start_time9 = msg9->header.stamp;
